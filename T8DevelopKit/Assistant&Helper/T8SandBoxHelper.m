...
@implementation T8SandBoxHelper

DEF_SINGLETON(T8SandBoxHelper)

+ (NSString *)appPath
{
    return [[T8SandBoxHelper sharedInstance] appPath];
}
...
+ (NSString *)docPath
{
    return [[T8SandBoxHelper sharedInstance] docPath];
}
...
{
    return [[T8SandBoxHelper sharedInstance] libPrefPath];
}
...
{
    return [[T8SandBoxHelper sharedInstance] libCachePath];
}
...
+ (NSString *)tmpPath
{
    return [[T8SandBoxHelper sharedInstance] tmpPath];
}
...
+ (NSString *)resPath:(NSString *)file{
    return [[T8SandBoxHelper sharedInstance] resPath:file];
}
...
{
    return [[T8SandBoxHelper sharedInstance] touch:path];
}
...
{
    return [[T8SandBoxHelper sharedInstance] touchFile:file];
}
