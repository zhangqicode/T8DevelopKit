...
@implementation T8PlaceHolderTextView
...
- (NSUInteger)numberOfLinesOfText {
    return [T8PlaceHolderTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [T8PlaceHolderTextView maxCharactersPerLine]) + 1;
}
...
- (void)setup {
    ...
    _placeHolderTextColor = UIColorRGB(0xa0a9ae);
